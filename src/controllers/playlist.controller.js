...
const getUserPlaylists = asyncHandler(async (req, res) => {
  ...
  return res
    .status(200)
    .json(new apiResponce(200, playlists, "User playlists"));
});
...
const addVideoToPlaylist = asyncHandler(async (req, res) => {
  ...
  return res
    .status(200)
    .json(new apiResponce(200, addVideo, "Video added to playlist"));
});
...
const removeVideoFromPlaylist = asyncHandler(async (req, res) => {
  ...
  return res
    .status(200)
    .json(new apiResponce(200, removeVideo, "Video removed from playlist"));
});
...
const deletePlaylist = asyncHandler(async (req, res) => {
  ...
  return res
    .status(200)
    .json(new apiResponce(200, playlist, "Playlist deleted successfully"));
});
